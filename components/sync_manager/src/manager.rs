...
impl SyncManager {
    ...
    pub fn disconnect(&mut self) {
        ...
        if let Some(addresses) =
            Self::autofill_engine("addresses").expect("autofill addresses engine")
        {
        ...
        if let Some(credit_cards) =
            Self::autofill_engine("creditcards").expect("autofill credit cards engine")
        {
